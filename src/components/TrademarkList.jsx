...
import ImgUna from '../images/ImgUna.png';
...
const TrademarkList = ({ search }) => {
  ...
  return (
    <Box p="4" bg="white" borderWidth="1px" borderRadius="md" mt="4">
      <Box mb="4" p="4" bg="white.100" borderRadius="md" textAlign="left">
        <Text fontSize="lg" fontWeight="bold">
          Try searching for{" "}
          <Box as="span" bg="orange.200" p="1" borderRadius="md">
            nike*
          </Box>
          <Box as="span" bg="orange.200" p="1" borderRadius="md" ml="2">
            *ike
          </Box>
        </Text>
      </Box>
